                      ...
                      (showFilter)
                          ? Column(
                              children: [
                                ...
                                // Padding(padding: EdgeInsets.symmetric(vertical: MySize.size6),), Row(children: [Text("${AppLocalizations.of(context).translate('invoice_status')} : ", style: AppTheme.getTextStyle(themeData.textTheme.bodyLarge, fontWeight: 600),), invoiceStatus()],),
                              ],
                            )
                          : Container()
                    ],
              ...
              Row(
                ...
                children: <Widget>[
                  Visibility(
                    ...
                    child: Row(
                      children: [
                        // (canEditSell) ? IconButton(icon: Icon(MdiIcons.fileDocumentEditOutline, color: themeData.colorScheme.onSurface,), onPressed: () {Navigator.pushNamed(context, '/cart', arguments: Helper().argument(locId: sellList[index]['location_id'], sellId: sellList[index]['id'], isQuotation: sellList[index]['is_quotation']));}) : Container(),
                        (canDeleteSell)
                            ? IconButton(
                                icon: Icon(
                                  MdiIcons.deleteOutline,
